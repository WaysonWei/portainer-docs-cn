...
Portainer支持通过多种方式连接到Docker环境。根据您的需求选择最适合的方法：

* **Agent** - 推荐用于大多数情况。Portainer Agent作为容器运行在您的Docker主机上，提供完整的Portainer功能集。
...
| 方法 | 优点 | 缺点 |
|------|------|------|
| **Agent** | 完整功能支持<br>实时通信<br>最佳性能 | 需要在主机上部署Agent |
...
* 确保您的Docker环境满足[系统要求](../../../../start/requirements-and-prerequisites.md)
